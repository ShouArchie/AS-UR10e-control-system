...
const BUFFER_SIZE: usize = 600_000; // 10 seconds at 60kHz
const DISPLAY_SAMPLES: usize = 30_000; // Show last 0.5 seconds at 60kHz
...
impl HighPerfDataCollector {
    fn new() -> Self {
        ...
        Self {
            ...
            sample_rate: 60000.0, // Updated to 60kHz
